...
import sty from "./PlasmicTvPlusGalleryItem.module.css"; // plasmic-import: QhrxP5l-JNNe/css

import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: 0nZ3RtQbJh0r/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___88Hyl)}
      >
        <Button
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___0Nnhb)}
        >
          <h5
            className={classNames(
              projectcss.all,
          ...
          <h5
            className={classNames(projectcss.all, projectcss.h5, sty.h5__bOaK7)}
          >
            {renderPlasmicSlot({
