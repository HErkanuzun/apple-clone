...
import sty from "./PlasmicProductDisplay.module.css"; // plasmic-import: x9bv9ccWc1-K/css
...
function PlasmicProductDisplay__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ygnwE)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__alK5H, {
            [sty.imgdark__alK5HejcJ6]: hasVariant($state, "dark", "dark"),
            [sty.imgisMobileView__alK5HjqGxh]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__xfDbM, {
            [sty.imgisMobileView__xfDbMjqGxh]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__je3AT, {
          [sty.freeBoxreverse__je3ATamjQr]: hasVariant(
            $state,
            "reverse",
            "reverse"
          )
      ...
      >
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__sy5Ou, {
            [sty.freeBoxdark__sy5OuejcJ6]: hasVariant($state, "dark", "dark")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__fH1Ib)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__nUsLv)}
                      role={"img"}
                    />
                  }
                  size={"large"}
                ...
                <Button
                  className={classNames("__wab_instance", sty.button__kOsR)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__l9Sp6)}
                      role={"img"}
                    />
                  }
                  size={"large"}
