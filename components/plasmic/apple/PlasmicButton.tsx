...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Kjg3Dfob1Bct/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: CF8aTqxURyZX/icon
      ...
      >
        ...
        {(hasVariant($state, "withIcons", "withSuffixIcon") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__reho)}
                  role={"img"}
                />
              ),
