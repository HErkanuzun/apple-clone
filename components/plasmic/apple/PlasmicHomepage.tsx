...
// Plasmic Project: pPgoHaTg76TzcgwCm5xnWc
// Component: -ZsAMJjIhKzU
...
import NavItem from "../../NavItem"; // plasmic-import: l3tD1mGLpElI/component
import NavItemDetails from "../../NavItemDetails"; // plasmic-import: XdIrwNxl0PS3/component
import ProductDisplay from "../../ProductDisplay"; // plasmic-import: x9bv9ccWc1-K/component
import Button from "../../Button"; // plasmic-import: Kjg3Dfob1Bct/component
import { CmsQueryRepeater } from "@plasmicpkgs/plasmic-cms";
import { SliderWrapper } from "@plasmicpkgs/react-slick";
import { sliderHelpers as SliderWrapper_Helpers } from "@plasmicpkgs/react-slick";
import TvPlusGalleryItem from "../../TvPlusGalleryItem"; // plasmic-import: QhrxP5l-JNNe/component
import FooterLinksGroup from "../../FooterLinksGroup"; // plasmic-import: Atd_2ogqkRGR/component
import FooterLinksGroupMobile from "../../FooterLinksGroupMobile"; // plasmic-import: o3NfCbK95zZc/component
import { Fetcher } from "@plasmicapp/react-web/lib/data-sources";

import { useScreenVariants as useScreenVariants_1Fdr6H6P9ZnM } from "./PlasmicGlobalVariant__Screen"; // plasmic-import: 1Fdr6H6p9znM/globalVariant

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: pPgoHaTg76TzcgwCm5xnWc/projectcss
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: -ZsAMJjIhKzU/css

import BaselineApplesvgIcon from "./icons/PlasmicIcon__BaselineApplesvg"; // plasmic-import: t6RDqymWqQ3d/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: wDypSPKxowL0/icon
import Icon5Icon from "./icons/PlasmicIcon__Icon5"; // plasmic-import: 2b3wbbfFSWa8/icon
import Icon7Icon from "./icons/PlasmicIcon__Icon7"; // plasmic-import: TKi20ub1-0Uj/icon
import Icon6Icon from "./icons/PlasmicIcon__Icon6"; // plasmic-import: y5VCJrIOPl2s/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: 3Eb2-95DoeLC/icon
import Icon9Icon from "./icons/PlasmicIcon__Icon9"; // plasmic-import: zPCHatbVWI0z/icon
...
function PlasmicHomepage__RenderFunc(props: {
  ...
  const globalVariants = ensureGlobalVariants({
    screen: useScreenVariants_1Fdr6H6P9ZnM()
  });
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <NavItem
                className={classNames("__wab_instance", sty.navItem__baybe)}
                hasIconOnly={true}
                icon={
            ...
            >
              <NavItem
                className={classNames("__wab_instance", sty.navItem__lrplL)}
                icon={
                  <BaselineApplesvgIcon
                    className={classNames(projectcss.all, sty.svg__snV2N)}
                    role={"img"}
                  />
                }
                text={"Mac"}
              ...
              <NavItem
                className={classNames("__wab_instance", sty.navItem__ezIaJ)}
                icon={null}
                text={
                  <div
                    className={classNames(
              ...
              <NavItem
                className={classNames("__wab_instance", sty.navItem__od6Gt)}
                text={"iPhone"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem__zad71)}
                text={"Watch"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem__p5JY)}
                text={"Vision"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem__q2GyS)}
                text={"AirPods"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem__dy52)}
                text={"TV & Home"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem__t85EH)}
                text={"Entertainment"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem___76KkY)}
                text={"Accessories"}
              />

              <NavItem
                className={classNames("__wab_instance", sty.navItem___6IZn9)}
                text={
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <NavItem
                className={classNames("__wab_instance", sty.navItem__x0I3P)}
                hasIconOnly={true}
                icon={
                  <Icon2Icon
              ...
              <NavItem
                className={classNames("__wab_instance", sty.navItem___6Kw89)}
                hasIconOnly={true}
                icon={
                  <Icon5Icon
              ...
              <NavItem
                className={classNames("__wab_instance", sty.navItem__em96V)}
                hasIconOnly={true}
                icon={
                  <Icon7Icon
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__huR7E)}
          >
            <ProductDisplay
              className={classNames(
                "__wab_instance",
                sty.productDisplay___6Sfwo
              )}
              imageSmallSrc={{
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__fuZtn)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__evka)}
                    iconLeft={
                      <Icon6Icon
            ...
            <ProductDisplay
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__p58QZ)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__n4Xpy)}
                    iconLeft={
                      <Icon6Icon
            ...
            <ProductDisplay
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__pz9Bb)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button___2KeXq)}
                    iconLeft={
                      <Icon6Icon
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__iRbU)}
          >
            <ProductDisplay
              className={classNames(
                "__wab_instance",
                sty.productDisplay__cmwmM
              )}
              description={
                <div
                  className={classNames(
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__dmRhv)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__oorR0)}
                    iconLeft={
                      <Icon6Icon
            ...
            <ProductDisplay
              className={classNames("__wab_instance", sty.productDisplay__ayR)}
              dark={true}
              description={
                <div
                  className={classNames(
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__alXsj)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__aj8Iy)}
                    iconLeft={
                      <Icon6Icon
              ...
              title={
                <div className={classNames(projectcss.all, sty.freeBox__sVEbE)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__snvAg)}
                  >
                    <Icon3Icon
                      className={classNames(projectcss.all, sty.svg__eOx3X)}
                      role={"img"}
                    />
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__frHNx)}
          >
            <ProductDisplay
              className={classNames("__wab_instance", sty.productDisplay__hY0L)}
              description={
                <div
                  className={classNames(
                    projectcss.all,
              ...
              links={
                <Button
                  className={classNames("__wab_instance", sty.button__zLwK6)}
                  iconLeft={
                    <Icon6Icon
              ...
              reverse={true}
              title={
                <div className={classNames(projectcss.all, sty.freeBox__m7BtR)}>
                  <Icon3Icon
                    className={classNames(projectcss.all, sty.svg__wHr0K)}
                    role={"img"}
                  />
            ...
            <ProductDisplay
              ...
              links={
                <Button
                  className={classNames("__wab_instance", sty.button___6JBdR)}
                  iconLeft={
                    <Icon6Icon
              ...
              title={
                <div className={classNames(projectcss.all, sty.freeBox__vr9E0)}>
                  <Icon3Icon
                    className={classNames(projectcss.all, sty.svg__ux5Ld)}
                    role={"img"}
                  />
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gnd73)}
          >
            <ProductDisplay
              className={classNames(
                "__wab_instance",
                sty.productDisplay__u6Ofl
              )}
              description={
                <div
                  className={classNames(
              ...
              links={
                <Button
                  className={classNames("__wab_instance", sty.button__aO6Nt)}
                  iconLeft={
                    <Icon9Icon
              ...
              title={
                <div className={classNames(projectcss.all, sty.freeBox__qqg10)}>
                  <Icon3Icon
                    className={classNames(projectcss.all, sty.svg__n9X8M)}
                    role={"img"}
                  />
            ...
            <ProductDisplay
              ...
              links={
                <React.Fragment>
                  <Button
                    className={classNames("__wab_instance", sty.button__eFbwa)}
                    iconLeft={
                      <Icon6Icon
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__lh0Ji)}
                    iconLeft={
                      <Icon6Icon
              ...
              title={
                <div className={classNames(projectcss.all, sty.freeBox__x3Jh2)}>
                  <Icon3Icon
                    className={classNames(projectcss.all, sty.svg__f4VmC)}
                    role={"img"}
                  />
          ...
          <CmsQueryRepeater
            className={classNames("__wab_instance", sty.cmsDataFetcher__baCeY)}
            desc={true}
            emptyMessage={
              <DataCtxReader__>
                {$ctx => (
          ...
          >
            ...
            <CmsQueryRepeater
              className={classNames("__wab_instance", sty.cmsDataFetcher__egOl)}
              desc={false}
              emptyMessage={
                <DataCtxReader__>
                  {$ctx => (
            ...
            >
              <DataCtxReader__>
                {$ctx => (
                  <React.Fragment>
                    <div
                      className={classNames(projectcss.all, sty.freeBox__b1PtM)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tKdyG)}>
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__hzrQe)}
              >
                <div
                  className={classNames(
                    projectcss.all,
